...
3 | Asset Type | int ||애셋의 타입입니다.<br>1: 텍스트 소재<br>제공 시점 현재 택스트 소재만을 지원합니다.
...
6 | regTm | date || 애셋의 등록 일시 입니다. 날짜 형식은 ISO8601 정의를 따릅니다.
7 | delTm | date | |애셋의 삭제 일시 입니다. 날짜 형식은 ISO8601 정의를 따릅니다.

<br>

**반응형 소재 연결 마스터 (item = ADASSETLINK)**
...
6 | Pin | string |10| 광고주가 설정한 광고 표시 위치를 의미합니다. 1은 첫 번째 위치 표시이며, 2는 두 번째 위치 표시를 나타냅니다.
7 | regTm | date || 반응형 소재 링크의 생성 일시 입니다. 날짜 형식은 ISO8601 정의를 따릅니다.
8 | delTm | date || 반응형 소재 링크의 삭제 일시 입니다. 날짜 형식은 ISO8601 정의를 따릅니다.

<br>

**반응형 소재 마스터 (item = RSAAD)**
...
8 | regTm | date || 반응형 소재의 생성 일시 입니다. 날짜 형식은 ISO8601 정의를 따릅니다.
9 | delTm | date || 반응형 소재의 삭제 일시 입니다. 날짜 형식은 ISO8601 정의를 따릅니다.
...
**AD AssetLink Master (item = ADASSETLINK)**
